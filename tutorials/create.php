                ...
                <div>
                    <div class="tab-content">
                        <div id="languagetabs-one" role="tabpanel" class="tab-pane active" aria-expanded="true">
                            ...
                            <div class="col-lg-10 is-table-row">
                                ...
                                <div class="col-lg-3 col-md-6 text-center box box">
                                    ...
                                    <p class="text-muted mb-0">Füllen Sie die Felder des Formulars aus</p>
                                    <ul class="text-left">
                                        <small> <li> Felder mit * sind Pflichtfelder und müssen ausgefüllt werden, andernfalls kann kein JSON-LD-Datensatz generiert werden</li></small>
                                        <small><li>Begriffe, die unterstrichen sind, beinhalte eine Beschreibung. Per Mausklick wird ein Pop-up mit der Definition geladen. Bei Verwendung der Sprachen Deutsch, Französisch und Italienisch wird eine maschinelle Übersetzung ausgegeben. (Bitte mit Vorsicht geniessen)</li></small>
                                    </ul>
                                ...
                                <div class="col-lg-3 col-md-6 text-center box">
                                    ...
                                    <p class="text-muted mb-0">Drücken Sie den Button «JSON erzeugen», wenn Sie alle erforderlichen Daten eingegeben haben</p>
                                </div>
                        ...
                        <div id="languagetabs-two" role="tabpanel" class="tab-pane" aria-expanded="false">
                            ...
                            <div class="col-lg-10 headline">
                                <h1> Documentation</h1>
                                <h2 class="section-heading">How do I create the JSON Code for my Events?</h2>
                            </div>
                            ...
                            <div class="col-lg-10 is-table-row">
                                <div class="col-lg-3 col-md-6 text-center box">
                                    ...
                                    <p class="text-muted mb-0">Choose within the selector<br> <a href="index.php" class="btn btn-primary"> Forms </a> <br> the right form you need</p>
                                </div>

                                <div class="col-lg-3 col-md-6 text-center box">
                                    <i class="fa fa-4x fa-newspaper-o text-primary mb-3 sr-icons"></i>
                                    <h3 class="mb-3">Step 2</h3>
                                    <p class="text-muted mb-0">Fill in the fields of the form</p>
                                    <ul class="text-left">
                                        <p>Fields that are marked with * are mandatory fields and have to be filled in, otherwise the dataset can't be generated. Terms which are underlined contain a description. Please click on the terms and a popup window with
                                            an explanation will appear. Using German, English or French lanugage, the translation will be done automatically through google translate and thus can contain some errors. </p>
                                    </ul>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 text-center box">
                                    ...
                                    <p class="text-muted mb-0">
                                        Press the "Create JSON Button" when you're done and entered all necessary data into the form.
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 text-center box">
                                    ...
                                    <p class="text-muted mb-0">
                                        Copy the JSON-LD script to your clipboard and place the code within your header of your website. Further tutorials on this can be found under <a href="index.php" class="btn btn-primary"> Implement to my page </a> </p><br>
                                </div>
                            </div>
                            <!-- ENDE ERKLAERUNG EN -->
                        </div>
                        ...
                        <div id="languagetabs-three" role="tabpanel" class="tab-pane" aria-expanded="false">
                            ...
                            <div class="col-lg-10 is-table-row">
                                <div class="col-lg-3 col-md-6 text-center box">
                                    ...
                                    <p class="text-muted mb-0">Choisissez dans le sélecteur<br> <a href="index.php" class="btn btn-primary"> Formes </a> <br> le formulaire dont vous avez besoin.</p>
                                </div>

                                <div class="col-lg-3 col-md-6 text-center box">
                                    <i class="fa fa-4x fa-newspaper-o text-primary mb-3 sr-icons"></i>
                                    <h3 class="mb-3">Étape 2</h3>
                                    <p class="text-muted mb-0">Remplissez les espaces du formulaire</p>
                                    <ul class="text-left">
                                        <p>Les espaces marqués d'un * sont des espaces obligatoires et doivent être remplis, sinon le JSON-code avec les dates ne peut pas être généré. Les termes soulignés contiennent une description. Cliquez sur les termes S'il
                                            vous plaît et une fenêtre contextuelle avec une explication apparaîtra .En utilisant le lanugage allemand, anglais ou français, la traduction se fera automatiquement via google translate et peut donc contenir quelques
                                            erreurs. </p>
                                    </ul>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 text-center box">
                                    ...
                                    <p class="text-muted mb-0">Appuyez sur le bouton "Créer un bouton JSON" lorsque vous avez terminé et entré toutes les données nécessaires dans le formulaire.</p>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-6 text-center box">
                                    ...
                                    <p class="text-muted mb-0">
                                        Copiez le script JSON-LD dans votre bloc-notes (clipboard) et placez le code dans le "header" de votre site Web. D'autres tutoriels sur ce sujet peuvent être trouvés sous <a href="index.php" class="btn btn-primary"> "Implémenter sur ma page" </a></p><br>
                                </div>
                            </div>
                            <!-- ENDE ERKLAERUNG FR -->
                        </div>
